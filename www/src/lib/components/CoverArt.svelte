...
<div
	class="aspect-video w-full md:w-1/2 md:aspect-square relative bg-neutral-900 p-2 2xl:p-8 flex-shrink-0 mx-auto flex items-center justify-center"
>
	<div
	...
	>
		<img class="block w-full h-full max-w-full object-cover" {src} {alt} />
	</div>
	<div
	...
	>
		<img
			{src}
			{alt}
			class="block w-full h-full md:h-auto object-contain md:w-auto max-w-full relative z-10"
		/>
	</div>
</div>
